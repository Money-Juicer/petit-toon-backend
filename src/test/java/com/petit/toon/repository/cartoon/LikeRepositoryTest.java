...
class LikeRepositoryTest {
    ...
    @Test
    @DisplayName("cartoon id로 like 엔티티를 조회한다")
    void findAllByCartoonId() {
        ...
        Like like1 = createLike(user2, cartoon);
        Like like2 = createLike(user3, cartoon);

        // when
        List<Like> likes = likeRepository.findAllByCartoonId(cartoon.getId());

        // then
        assertThat(likes).contains(like1, like2);
    }
